...
$functions = array(
    ...
    'local_course_add_new_course_module_lesson' => array(
        'classname' => 'local_sync_service_external',
        'methodname' => 'local_sync_service_add_new_course_module_lesson',
        'classpath' => 'local/sync_service/externallib.php',
        'description' => 'Add course module Lesson',
        'type' => 'write',
        'ajax' => true,
...
$services = array(
    'Course Sync Extension Service' => array(
        'functions' => array(
            ...
            "local_course_add_new_course_module_lesson",
